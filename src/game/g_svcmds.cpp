...
} svcmds[ ] =
{
    ...
    { "status", false, Svcmd_Status_f },
    { "stopMapRotation", false, G_StopMapRotation },
    { "suddendeath", false, Svcmd_SuddenDeath_f }
};
...
bool  ConsoleCommand( void )
{
    ...
    command = ( svcmd* )bsearch( cmd, svcmds, ARRAY_LEN( svcmds ),
