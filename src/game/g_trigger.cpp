...
void Use_Multi(gentity_t *ent, gentity_t *other, gentity_t *activator) { multi_trigger(ent, activator); }
...
===============
*/
void trigger_teleporter_use(gentity_t *ent, gentity_t *other, gentity_t *activator) { ent->s.eFlags ^= EF_NODRAW; }
...
===============
*/
void trigger_stage_use(gentity_t *self, gentity_t *other, gentity_t *activator) { G_UseTargets(self, self); }
...
===============
*/
void trigger_win(gentity_t *self, gentity_t *other, gentity_t *activator) { G_UseTargets(self, self); }
...
===============
*/
bool trigger_buildable_match(gentity_t *self, gentity_t *activator)
{
    int i = 0;
...
===============
*/
void trigger_buildable_use(gentity_t *ent, gentity_t *other, gentity_t *activator) { ent->s.eFlags ^= EF_NODRAW; }
...
===============
*/
bool trigger_class_match(gentity_t *self, gentity_t *activator)
{
    int i = 0;
...
===============
*/
void trigger_class_use(gentity_t *ent, gentity_t *other, gentity_t *activator) { ent->s.eFlags ^= EF_NODRAW; }
...
===============
*/
bool trigger_equipment_match(gentity_t *self, gentity_t *activator)
{
    int i = 0;
...
===============
*/
void trigger_equipment_use(gentity_t *ent, gentity_t *other, gentity_t *activator) { ent->s.eFlags ^= EF_NODRAW; }
