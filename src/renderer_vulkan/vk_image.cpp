...
static void R_CreateDefaultImage( void )
{
	...
	tr.defaultImage = R_CreateImage("*default", (unsigned char *)data, DEFAULT_SIZE, DEFAULT_SIZE, true, false, GL_REPEAT, VK_TRUE);
}
...
static void R_CreateWhiteImage(void)
{
	...
	tr.whiteImage = R_CreateImage("*white", (unsigned char *)data, 8, 8, false, false, GL_REPEAT, VK_TRUE);
}
...
static void R_CreateIdentityLightImage(void)
{
	...
	tr.identityLightImage = R_CreateImage("*identityLight", (unsigned char *)data, 8, 8, false, false, GL_REPEAT, VK_FALSE );
}
...
static void R_CreateDlightImage( void )
{
	...
	tr.dlightImage = R_CreateImage("*dlight", (unsigned char *)data, DLIGHT_SIZE, DLIGHT_SIZE, false, false, GL_CLAMP, VK_TRUE );
}
...
static void R_CreateFogImage( void )
{
	...
	// what we want.
	tr.fogImage = R_CreateImage("*fog", (unsigned char *)data, FOG_S, FOG_T, false, false, GL_CLAMP, VK_TRUE );
...
static void R_CreateScratchImage(void)
{
    ...
    for(x=0;x<32;x++)
    {
        ...
        tr.scratchImage[x] = R_CreateImage("*scratch", (unsigned char *)data, DEFAULT_SIZE, DEFAULT_SIZE, false, true, GL_CLAMP, VK_TRUE);
    }
}
