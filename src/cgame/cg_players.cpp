  ...
  if( old->team != _new->team )
  {
    if( _new->team == TEAM_NONE )
      ...
      CG_Printf( "%s" S_COLOR_WHITE " left the %ss and joined the %ss\n",
        _new->name, BG_TeamName( old->team ), BG_TeamName( _new->team ) );
  }
}
...
static qboolean CG_PlayerShadow( centity_t *cent, float *shadowPlane, class_t klass )
{
  ...
  *shadowPlane = 0;
  ...
  CG_ImpactMark( cgs.media.shadowMarkShader, trace.endpos, trace.plane.normal,
                 ...
                 24.0f * BG_ClassConfig( klass )->shadowScale, qtrue );
...
static void CG_PlayerSplash( centity_t *cent, class_t klass )
{
  ...
  CG_ImpactMark( cgs.media.wakeMarkShader, trace.endpos, trace.plane.normal,
                 ...
                 32.0f * BG_ClassConfig( klass )->shadowScale, qtrue );
}
