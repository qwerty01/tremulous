...
{
  { "+button2",       "Activate Upgrade",       { K_NONE, K_NONE } },
  { "+speed",         "Run/Walk",               { K_NONE, K_NONE } },
  { "+button6",       "Dodge",                  { K_NONE, K_NONE } },
  { "+button8",       "Sprint",                 { K_NONE, K_NONE } },
  { "+moveup",        "Jump",                   { K_NONE, K_NONE } },
  { "+movedown",      "Crouch",                 { K_NONE, K_NONE } },
  { "+attack",        "Primary Attack",         { K_NONE, K_NONE } },
  { "+button5",       "Secondary Attack",       { K_NONE, K_NONE } },
  { "reload",         "Reload",                 { K_NONE, K_NONE } },
  { "buy ammo",       "Buy Ammo",               { K_NONE, K_NONE } },
  { "itemact medkit", "Use Medkit",             { K_NONE, K_NONE } },
  { "+button7",       "Use Structure/Evolve",   { K_NONE, K_NONE } },
  { "deconstruct",    "Deconstruct Structure",  { K_NONE, K_NONE } },
  { "weapprev",       "Previous Upgrade",       { K_NONE, K_NONE } },
  { "weapnext",       "Next Upgrade",           { K_NONE, K_NONE } }
};
