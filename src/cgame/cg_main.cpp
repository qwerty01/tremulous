...
static void CG_SetUIVars( void )
{
    ...
    *carriageCvar = 0;
    ...
    if( BG_Weapon( ( weapon_t )cg.snap->ps.stats[ STAT_WEAPON ] )->purchasable )
...
static void CG_RegisterClients( void )
{
    ...
    {
        CG_PrecacheClientInfo( ( class_t )i, BG_ClassConfig( ( class_t )i )->modelName,
                               BG_ClassConfig( ( class_t )i )->skinName );
...
static bool CG_OwnerDrawHandleKey( int ownerDraw, int key )
{
    return false;
}
...
static bool CG_OwnerDrawVisible( int parameter )
{
    return false;
}
...
static bool keyOverstrikeMode = false;
