...
extern "C" Q_EXPORT intptr_t vmMain( int command, int arg0, int arg1, int arg2 )
{
  switch( command )
  {
    ...
    case CG_DRAW_ACTIVE_FRAME:
      CG_DrawActiveFrame( arg0, static_cast<stereoFrame_t>(arg1), static_cast<qboolean>(arg2) );
      return 0;
    ...
    case CG_KEY_EVENT:
      CG_KeyEvent( arg0, static_cast<qboolean>(arg1) );
      return 0;
...
void CG_RegisterCvars( void )
{
  ...
  cgs.localServer = static_cast<qboolean>(atoi( var ));
}
